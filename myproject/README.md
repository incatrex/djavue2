...
Install docker and nginx. Create an empty postgres database myproject owned by a user myproject.

On your remote machine, create a file ~/myproject.env:

```
DJANGO_DB_PASSWORD=<myproject's password>
DJANGO_DB_HOST=<database_ip>
DJANGO_DB_NAME=myproject
DJANGO_DB_USER=myproject
DJANGO_DEBUG=0
```
...
server {
    ...
    location /static {
        alias /home/ubuntu/dkdata/myproject/static;
...
(Replace "myproject.example.com" with your production domain)
